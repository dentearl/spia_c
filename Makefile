...
production:
	./spia --dir charlieParse/ --de testData/DE_Colorectal.tab --array testData/ALL_Colorectal.tab
debug:
	gdb spia # --dir testPathways/ --de testData/DE_Colorectal.tab --nBoots 2000 --array testData/ALL_Colorectal.tab
